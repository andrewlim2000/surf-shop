...
module.exports = {
  ...
  getForgetPw(req, res, next) {
    res.render('users/forgot');
  },
  async putForgetPw(req, res, next) {
    ...
    const msg = {
      to: email,
      from: 'Surf Shop Admin <2000andrewlim@gmail.com>',
    ...
    console.log("before sgMail.send(msg)");
    await sgMail.send(msg);
    console.log("after sgMail.send(msg)");
  ...
  async putReset(req, res, next) {
    ...
    const msg = {
      ...
      text: `Hello,
      This email is to inform that the password for your account has just been changed.
